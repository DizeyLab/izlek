...
pub fn t(lang: Lang, key: Key) -> &'static str {
    ...
    use Lang::*;
    match (key, lang) {
        (AddATask, En) => "Add a task",
        (AddATask, Tr) => "Görev ekle",
        (WhatNeedsDoing, En) => "What needs doing?",
        (WhatNeedsDoing, Tr) => "Ne yapılmalı?",
        (Add, En) => "Add",
        (Add, Tr) => "Ekle",
        (Cancel, En) => "Cancel",
        (Cancel, Tr) => "Vazgeç",
        (ThisBoardIsEmpty, En) => "This board is empty",
        (ThisBoardIsEmpty, Tr) => "Bu pano boş",
        ...
        (Save, En) => "Save",
        (Save, Tr) => "Kaydet",
        (NoDescriptionYet, En) => "No description yet.",
        (NoDescriptionYet, Tr) => "Henüz açıklama yok.",
        ...
        (NothingBlocksThisTask, En) => "Nothing blocks this task.",
        (NothingBlocksThisTask, Tr) => "Bu görevi engelleyen bir şey yok.",
        (Files, En) => "FILES",
        (Files, Tr) => "DOSYALAR",
        (NoFilesYet, En) => "No files yet.",
        (NoFilesYet, Tr) => "Henüz dosya yok.",
        (File, En) => "File",
        (File, Tr) => "Dosya",
        (Attach, En) => "Attach",
        (Attach, Tr) => "Ekle",
        ...
        (PasswordSetPlaceholder, En) => "Set — type a new one to replace it",
        (PasswordSetPlaceholder, Tr) => "Ayarlı — değiştirmek için yenisini yaz",
        ...
        (LowerLimitNote, En) => "A lower limit never touches files already uploaded.",
        (LowerLimitNote, Tr) => "Düşürülen bir limit zaten yüklenmiş dosyalara dokunmaz.",
        (Members, En) => "Members",
        (Members, Tr) => "Üyeler",
        (NameCol, En) => "NAME",
        (NameCol, Tr) => "AD",
        ...
        (RoleNoteAdminLabel, En) => "Admin",
        (RoleNoteAdminLabel, Tr) => "Yönetici",
        (RoleNoteAdminDesc, En) => "— sender, limits, members.",
        (RoleNoteAdminDesc, Tr) => "— gönderen, limitler, üyeler.",
        (RoleNoteMemberLabel, En) => "Member",
        (RoleNoteMemberLabel, Tr) => "Üye",
        (RoleNoteMemberDesc, En) => "— board and rule mail.",
        (RoleNoteMemberDesc, Tr) => "— pano ve kural postası.",
        (RoleNoteViewerLabel, En) => "Viewer",
        (RoleNoteViewerLabel, Tr) => "İzleyici",
        (RoleNoteViewerDesc, En) => "— read and export only.",
        (RoleNoteViewerDesc, Tr) => "— sadece okuma ve dışa aktarma.",
