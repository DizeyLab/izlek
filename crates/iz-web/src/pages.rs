//! The account screens, ported from `iz-web/src/pages.rs`'s FirstLogin
...
/// "Set up İz" — the first account in an empty workspace.
                    ...
                    <form method="post" action="/api/claim_workspace" data-hard="">
                        ...
                        <label class="auth-field">
                            ...
                            <input
                                ...
                                minlength=(iz_core::auth::MIN_PASSWORD_CHARS.to_string())
                                required=""
                            >
                        </label>
