...
/// `Escape` resolver on `window.__izEsc` (priority 95 — the dropdown
    ...
    const JS: &str = "\
        (function () {\
            ...
            function resync(select) {\
                ...
                window.__izOwn(select, ['dd-native'], []);\
            ...
            function enhance(select) {\
                ...
                window.__izOwn(select, [], ['data-dd-done']);\
            ...
            window.__izEsc.register(95, function () {\
